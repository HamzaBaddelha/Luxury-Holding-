...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
      ...
      <p className="text-lg md:text-xl leading-relaxed mb-10 max-w-2xl mx-auto" style={{ color: "hsl(220,10%,75%)" }}>
        استثمر في سيارات فاخرة وعقارات مميزة بدءاً من <strong style={{ color: "hsl(45,85%,68%)" }}>٥٠٠ ريال</strong> فقط، واحصل على عوائد تصل إلى <strong style={{ color: "hsl(45,85%,68%)" }}>٢٠٪</strong> سنوياً
      </p>
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="relative rounded-3xl overflow-hidden p-8 group cursor-pointer transition-transform hover:-translate-y-1" style={{ background: "linear-gradient(135deg, hsl(220,65%,15%), hsl(220,50%,22%))", border: "1px solid hsl(45 85% 58% / 0.2)" }}>
          ...
          <p className="mb-6" style={{ color: "hsl(220,10%,72%)" }}>موّل سيارات فاخرة وفان للتأجير واحصل على حصتك من الأرباح الشهرية</p>
